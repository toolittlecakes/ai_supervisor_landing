...
const content: Content = {
  ...
  personas: [
    {
      id: 1,
      title: "Устал от операционки и хочет сфокусироваться на терапии",
      items: [
        "Приходить на сессию подготовленным, а не вспоминать «что у нас там было?» за 5 минут до звонка",
        "Готовить кейс к супервизии за 15 минут вместо 3 часов",
        "Видеть всю историю кейса в одном месте, замечать то, что раньше ускользало в потоке"
      ]
    },
    {
      id: 2,
      title: "Хочет расти дальше, опираясь на факты",
      items: [
        "Получать непредвзятый разбор своих сессий",
        "Видеть на графиках, как реально растут навыки",
        "Уверенно повышать стоимость своей работы",
        "Понимать, что делать дальше"
      ]
    },
    {
      id: 3,
      title: "Кому супервизии раз в месяц уже недостаточно",
      items: [
        "Получать мгновенную «калибровку» после каждой сессии – сразу видеть, что сработало, а что нет",
        "Понимать динамику своей работы сразу по всем клиентам",
        "Больше не выбирать, какого клиента оставить «на следующий месяц» супервизии"
      ]
    }
  ],
  additionalTools: {
...
const AudienceSection = () => (
  <section className="py-16 px-4 bg-slate-50">
    <div className="max-w-6xl mx-auto">
      ...
      <p className="text-xl text-slate-600 text-center mb-12">
        Supervisor AI — для практикующих психологов среднего и высокого стажа, если:
      </p>
